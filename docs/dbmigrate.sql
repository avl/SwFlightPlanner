...
alter table waypoint ADD COLUMN stay_id integer default null;
alter table waypoint drop COLUMN stay_id;
alter table waypoint add constraint waypoint_user_fkey2 FOREIGN KEY ("user","trip","stay_id") REFERENCES "stay"("user","trip","waypoint_id") ON UPDATE CASCADE ON DELETE SET NULL;
